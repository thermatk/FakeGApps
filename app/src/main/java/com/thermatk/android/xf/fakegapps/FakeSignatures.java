            ...
            protected void afterHookedMethod(MethodHookParam param) {
                ...
                if (pi != null) {
                    ...
                    if (packageName.equals("com.google.android.gms") || packageName.equals("com.android.vending")) {
                        try {
                            String callerPackageName = "unknown package name";
                            String callerAppName = "unknown package label";

                            PackageManager pm;
                            try {
                                pm = AndroidAppHelper.currentApplication().getApplicationContext().getPackageManager();
                                callerPackageName = pm.getNameForUid(Binder.getCallingUid());

                                try {
                                    callerAppName = (String) pm.getApplicationLabel(pm.getApplicationInfo(callerPackageName, 0));
